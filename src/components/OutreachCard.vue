<template>
    ...
    <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 fit-content">
        ...
        <div class="p-5 flex flex-col justify-between">
            ...
            <div class="flex items-center align-middle text-align-center mt-1">
                <span class="bg-yellow-100 text-green-800 px-2.5 py-1.5 rounded text-xs font-medium w-max">
                    {{ data.location }}
                </span>
            </div>
