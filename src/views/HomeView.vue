  ...
  <PublicLayout>
      ...
      <div class="flex flex-col lg:flex-row w-full mx-auto max-w-screen-xl p-4 items-center justify-center lg:py-14">
        ...
        <div class="mx-auto max-w-screen-xl text-left	 w-full lg:w-2/3 py-4 lg:py-20">
          <h1 class="mb-4 text-4xl font-semibold text-primary md:text-5xl lg:text-6xl">Igniting Innovation,
            ...
            <a href="#"
            class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-secondary rounded border border-secondary hover:bg-secondary hover:text-white">
            Learn more
          </a>
        </div>
      </div>
    ...
    <section class="my-8 bg-white dark:bg-gray-900 py-10 px-4">
      ...
      <section class="mx-auto max-w-screen-2xl w-full py-4 lg:pt-10">
        ...
        <swiper :modules="modules" :slides-per-view="isMobile ? 1 : 2" :space-between="30" :speed="1000" :loop="true"
          :autoplay="{
      delay: 3000,
          ...
          <template v-for="startup in startUps" :key="startup.id">
            ...
            <swiper-slide>
              ...
              <div class="bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700 w-full"
                :class="isMobile ? '' : 'fit-content mx-auto flex flex-row justify-between'">

                <div class="relative overflow-hidden border-gray-200 dark:border-gray-800 p-4 m-auto"
                  :class="isMobile ? 'w-full my-2' : 'w-1/4'">
