        ...
        <section class="bg-bgwhite">
            <div
                ...
                <div class="mx-auto max-w-screen-xl text-left w-full lg:w-2/3 py-4 lg:py-20">
                    <h1 class="mb-4 text-4xl font-semibold text-primary md:text-5xl lg:text-6xl">Our Story: Fueling
                        Innovation at Inovus Labs.</h1>
                        <p class="mb-8 text-lg font-light text-secondary lg:text-xl">Discover the
                            genesis, purpose, and vision that fuels Inovus Labs IEDC's commitment to innovation and
                            entrepreneurship.</p>
            ...
            <div class="w-full lg:w-1/3 py-4 lg:py-20">
                <img class="w-full h-full" src="https://storage.googleapis.com/inovuslabs-cdn.appspot.com/assets/illustrations/team-work-animate.svg" alt="Team" />
            </div>
        </div>
    </section>
        ...
        <section class="py-10 px-4">
            ...
            <div class="mx-auto max-w-screen-xl text-left w-full py-4 lg:pt-10">
                <h1
                    ...
                    Dive into the evolution of leadership! </h1>
                <p class="mb-6 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">
                    Explore the Execom Teams section, a glimpse into the dynamic individuals who have steered our course
