    ...
    <PublicLayout>
        ...
        <section class="bg-bgPrimary">
            ...
            <div class="w-full lg:w-1/3 py-4 lg:py-20">
                <img class="w-full h-full" src="../../public/assets/illustrations/contact.svg" />
            </div>
            ...
            <div class="mx-auto max-w-screen-xl text-center w-full lg:w-2/3 py-4 lg:py-20">
                <h1 class="mb-4 text-4xl font-extrabold text-primary md:text-5xl lg:text-6xl">
                    Connect to Catalyze:<br/>Reach out to Inovus Labs!
                </h1>
                <p class="mb-8 text-lg font-normal text-secondary lg:text-xl sm:px-16 lg:px-46">
                    Your Gateway to Innovation & Learning – Let's Shape the Future Together. Contact Us Today!
                </p>
            ...
            <div class="gap-16 items-center px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:px-6">
                <div class="py-8 space-y-8">
                    ...
                    <div class="flex flex-col items-center justify-center border rounded-lg p-8 bg-gray-50 hover:bg-gray-100">
                        ...
                        <h3 class="mb-2 text-xl font-bold dark:text-white">Address:</h3>
                        <p class="text-gray-500 text-center dark:text-gray-400">Kristu Jyoti College of Management & Technology<br/>Chethipuzha P.O, Changanacherry, Kottayam, Kerala, India.</p>
                    </div>
