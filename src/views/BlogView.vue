...
<template>
    ...
    <section class="bg-bgPrimary">
        ...
        <div class="w-full lg:w-1/3 py-4 lg:py-20">
            <img class="w-full h-full" src="../../public/blog.svg" />
        </div>
        ...
        <div class="mx-auto max-w-screen-xl text-center w-full lg:w-2/3 py-4 lg:py-20">
            ...
            <p class="mb-8 text-lg font-normal text-secondary lg:text-xl sm:px-16 lg:px-48">
                Dive into Our Featured Blog Posts for a World of Perspectives!
            </p>
